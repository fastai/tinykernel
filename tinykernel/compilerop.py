"""Compiler tools with improved interactive support. From IPython.
...
* Fernando Perez
* Thomas Kluyver
* Minor modifications for tinykernel by Jeremy Howard
"""
...
#  tinykernel modifications (C) 2021 onwards Jeremy Howard.
#
...
def code_name(code, number=0, prefix='ipython'):
...
class CachingCompiler(codeop.Compile):
    ...
    def cache(self, transformed_code, number=0, raw_code=None, prefix='ipython'):
        ...
        name = code_name(transformed_code, number, prefix=prefix)
        entry = (
